from leapp.libraries.actor.library import read_nm_config, parser_nm_config, check_nm_dchp
...
class NetworkManagerReadConfig(Actor):
    ...
    def process(self):
        ...
        cfg = read_nm_config()
        parser = parser_nm_config(cfg)

        if parser is not None:
            check_nm_dchp(nm_cfg=nm_config, parser=parser)
